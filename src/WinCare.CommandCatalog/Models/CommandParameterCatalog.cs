...
appx-installed-remove|PackageNames:!a
appx-registered-remove|PackageNames:!a
appx-provisioned-remove|PackageNames:!a
appx-selection|PackageNames:!a
appx-selection-assess|PackageNames:!a
app-residual-discovery|MaxCandidates:i=100[1,1000];MaxEntriesPerCandidate:i=10000[1,100000];MaxDepth:i=4[0,32];LargestFileCount:i=10[1,100]
...
hardening-apply|ProfileId:s=balanced{balanced,hail-mary}
...
installer-cache-analysis|MaxFiles:i=5000[1,20000]
internals-processes|Top:i=50[1,500]
knowledge|Topic:s
launcher-open|Target:!s
launcher-search|Query:!s;Limit:i=50[1,500]
legacy-unsafe|Action:!s{flush-dns,restart-explorer}
...
maintenance-transition|Id:!s;State:!s{Scheduled,Running,Completed,Cancelled}
...
network-experiment|Setting:!s{AutoTuningLevel,EcnCapability,Timestamps};Value:!s
...
power-stop|Id:!s
preset|PresetId:!s
remediation-restore|ExecutionId:!s
...
remote-consent-state|Id:!s;State:!s{Active,Revoked,Expired}
...
storage-report|RootPath:!s;MaxEntries:i=25000[1,100000];MaxDepth:i=6[0,64];LargestFileCount:i=25[1,500]
