function Get-WinCareActionContractTable {
    ...
    Add-Contract 'ConfigureSysmon' @('ExecutablePath','ExecutableHash','ConfigPath','ConfigHash','Mode') @('ExecutablePath','ExecutableHash','ConfigPath','ConfigHash','Mode') 'High' $true $true 3600
    ...
    try{
        ...
        switch([string]$Action.Type){
            ...
            'ConfigureSysmon' {
                ...
                if([string]$parameters.Mode -notin @('Install','Update')){throw 'Sysmon mode is invalid.'}
            }
