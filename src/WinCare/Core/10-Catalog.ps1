...
function New-WinCareCatalogPlan {
    ...
    $catalog=Get-WinCareCatalog;$plan=New-WinCarePlan -Title $Title -Description 'Target-native, compatibility-aware Windows configuration plan.' -SourceRecords @('SRC:4726046a03')
