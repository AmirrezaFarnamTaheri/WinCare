...
function Get-WinCareOfflineReductionProfile {
    ...
    $profiles=@(
        [pscustomobject]@{
            ...
            DisableFeatures=@('Printing-XPSServices-Features','WorkFolders-Client','SMB1Protocol');ComponentCleanup='Standard';SourceRecords=@('D53-NANO-SUPPORTED-REDUCTION','D53-NANO-APPX-INVENTORY')
        },
        [pscustomobject]@{
            ...
            DisableFeatures=@('Printing-XPSServices-Features','WorkFolders-Client','SMB1Protocol');ComponentCleanup='Standard';SourceRecords=@('D53-NANO-SUPPORTED-REDUCTION','D56-TERMINAL-DEVELOPER-SURFACE')
        },
        [pscustomobject]@{
            ...
            AppxDisplayNames=@();DisableFeatures=@();ComponentCleanup='Standard';SourceRecords=@('D53-NANO-COMPONENT-CLEANUP')
        }
    )
