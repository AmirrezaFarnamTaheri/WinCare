            ...
            if($browser.Kind -eq 'Chromium'){
                foreach($profileItem in $profileCandidates){
                    ...
                    foreach($idItem in $idCandidates){
                        ...
                        try{
                            ...
                            $manifest=Get-Content -LiteralPath $manifestPath -Raw -Encoding utf8 -ErrorAction Stop|ConvertFrom-Json -AsHashtable -Depth 40
                ...
                foreach($profileItem in $profileCandidates){
                    ...
                    try{
                        ...
                        $doc=Get-Content -LiteralPath $extensionsPath -Raw -Encoding utf8 -ErrorAction Stop|ConvertFrom-Json -AsHashtable -Depth 60
