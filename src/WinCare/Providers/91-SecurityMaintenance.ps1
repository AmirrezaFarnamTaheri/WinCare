...
function Get-WinCareSecurityMaintenanceRoot {
    $path=Join-Path $script:WinCareState.Root 'SecurityMaintenance';$null=New-Item -ItemType Directory -Path $path -Force;$path
}
