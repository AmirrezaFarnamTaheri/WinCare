...
Describe 'Cleaner and preview contracts' {
    BeforeAll {
    ...
    It 'does not import QuickLook global keyboard hooks or plugin runtime' {
        ...
        $Provider|Should Match "SourceRecords=@\('SRC:65dbd15e56'\)"
    }

    It 'keeps duplicate external product concepts out of runtime authority' {
