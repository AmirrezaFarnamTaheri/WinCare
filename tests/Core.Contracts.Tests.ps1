...
Describe 'Versioned action and plan contracts' {
  InModuleScope WinCare {
    ...
    It 'rejects unknown action fields' {
      ...
      (Test-WinCareActionContract $action).Success | Should -BeFalse
    }
    ...
    It 'allows only DNS flush through elevated generic process' {
      ...
      (Test-WinCareActionContract $ok -ForElevation).Success | Should -BeTrue
      ...
      (Test-WinCareActionContract $bad -ForElevation).Success | Should -BeFalse
    }
    It 'rejects malformed cleanup action metadata before dispatch' {
      ...
      (Test-WinCareActionContract $badKind).Success | Should -BeFalse
      ...
      (Test-WinCareActionContract $badAge).Success | Should -BeFalse
      ...
      (Test-WinCareActionContract $badPattern).Success | Should -BeFalse
    }
    It 'rejects duplicate action IDs in a plan' {
      ...
      (Test-WinCarePlanContract (New-WinCarePlan -Title Test -Actions @($a,$b))).Success | Should -BeFalse
    }
    ...
    It 'requires an executable compensator for reversible actions' {
      ...
      (Test-WinCareActionContract $missing).Success|Should -BeFalse
      ...
      (Test-WinCareActionContract $valid).Success|Should -BeTrue
      ...
      (Test-WinCareActionContract $invalid).Success|Should -BeFalse
    }
    ...
    It 'requires an exact recent preview before applying a modifying plan' {
      ...
      Test-WinCarePlanPreviewReceipt -Plan $plan|Should -BeTrue
      $plan.Title='Mutated'
      Test-WinCarePlanPreviewReceipt -Plan $plan|Should -BeFalse
    }
  }
}
