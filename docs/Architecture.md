...
| **`native/wincare-guard`** | Standalone background health daemon monitoring RAM pressure, disk quota, and thermal status via Windows Toast XML notifications and Named Pipe IPC |
...
|  (259 Typed Command Definitions)   |               |     native/wincare-guard (Named Pipe IPC)     |
+------------------------------------+               +-----------------------------------------------+
```
