...
- Third-party licensing and release provenance remain separate in [THIRD-PARTY-NOTICES.md](../THIRD-PARTY-NOTICES.md), Git history, the generated SBOM, and the build receipt.
