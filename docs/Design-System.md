...
- `design/WinCare-Logo.svg` and `.png`
- `design/WinCare-GUI-Preview.svg` and `.png`
- `src/WinCare/Data/Gui/WinCare.ico`

The design assets are original WinCare product assets and do not copy third-party branding.
