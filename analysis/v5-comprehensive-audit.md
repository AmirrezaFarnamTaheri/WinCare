...
V5 is a coherent additive presentation convergence over the established engine. It does not fork authority, duplicate donor architectures, or use visual polish as a substitute for behavioral evidence. Promotion still depends on the exact frozen source and packaged-artifact gates.
