...
- Closed maintainability, protected-record, cleanup-authority, playbook-shape, telemetry, runtime-contract, clean-install, maintenance-CAS, canonical maintenance storage, playbook-provenance, playbook-enumeration, and remote-consent lifecycle regressions across the release validation matrix.
