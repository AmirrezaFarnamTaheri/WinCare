...
- Closed maintainability, protected-record, cleanup-authority, playbook-shape, telemetry, runtime-contract, clean-install, maintenance-CAS, playbook-provenance, and remote-consent lifecycle regressions across the release validation matrix.
