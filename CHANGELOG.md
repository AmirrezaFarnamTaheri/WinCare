...
- Closed maintainability, protected-record, cleanup-authority, playbook-shape, telemetry, runtime-contract, and clean-install regressions across the release validation matrix.
